...
import {BOARD_LAYOUT_VERSION,createBoard} from '../domain/board.js';
...
export function BoardPreview({board:providedBoard,compact=false}){
  ...
  const board=providedBoard?.layoutVersion===BOARD_LAYOUT_VERSION?providedBoard:fallback;
  ...
  return <div className={`board-preview board-preview-3d${compact?' board-compact':''}`}>
    ...
    <div className="board-preview-caption"><span>PLAYER FOLLOW CAMERA</span><b>HARBOR VILLAGE · STONE ROUTE</b></div>
  </div>;
}
